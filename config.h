...
// static const char *fonts[]          = { "Fira Code:bold:size=14","Symbols Nerd Font:bold:size=14:autohint=true", "Custom:bold:size=14", "JoyPixels:pixelsize=12"  };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,     XK_BackSpace,		spawn,			SHCMD("bootnxt") },
	...
	// { MODKEY|ShiftMask,		XK_r,				spawn,			SHCMD("st -e rambox") },
	...
	{ MODKEY|ShiftMask,		XK_x,				spawn,			SHCMD("mpc pause;pauseallmpv;xidlehook-client --socket $XIDLESOCK control --action trigger --timer 1;xset dpms force off &") },
